...
\begin{itemize}
  ...
  \item \textbf{비교 범위}: 본 연구의 주 비교는 단일 pass feed-forward와 per-scene optimization의 두 축이다. ReSplat~\cite{xu2026resplat}처럼 학습된 recurrent 갱신을 사용하는 계열은 별도의 패러다임으로 간주하여 본 비교에서 제외하였으며, 이에 대한 통제된 비교는 후속 과제로 남긴다.
\end{itemize}
