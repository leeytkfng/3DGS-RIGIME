...
15. **[다음]** fsgs_runner.py를 RE10K/DL3DV로 확장(현재 DTU만 지원) — 30-scene 본 실험에 FSGS를 포함하려면 선행 필요
16. co-visibility selector 연결
17. C1-a를 main subset **30 scene × seed 2회**로 스케일업(진짜 본 실험, 2026-08-13 grid 결정 반영) — 15번(FSGS RE10K/DL3DV 확장) 완료 후 Vanilla3DGS/MVSplat뿐 아니라 FSGS까지 포함해 착수
